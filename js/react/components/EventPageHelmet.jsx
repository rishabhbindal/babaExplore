...
class EventPageHelmet extends React.Component {
    static propTypes = {
    ...
    render() {
        ...
        return (
            <Helmet>
                ...
                <meta name="description" content={property.meta && property.meta.description} />
                ...
                <meta property="og:url" content={`${__HOST_URL__}/events/${property.code}`} />
...
export default EventPageHelmet;
